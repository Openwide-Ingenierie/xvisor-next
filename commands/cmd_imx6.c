...
#define MODULE_DESC			"Command i.MX6"
#define MODULE_AUTHOR			"Jimmy Durand Wesolowski"
#define MODULE_LICENSE			"GPL"
#define MODULE_IPRIORITY		0
#define	MODULE_INIT			cmd_imx6_init
#define	MODULE_EXIT			cmd_imx6_exit
...
static int __init cmd_imx6_init(void)
{
	return vmm_cmdmgr_register_cmd(&cmd_imx6);
}

static void __exit cmd_imx6_exit(void)
{
	vmm_cmdmgr_unregister_cmd(&cmd_imx6);
}

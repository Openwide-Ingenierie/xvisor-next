...
commands-objs-$(CONFIG_CMD_FB_LOGO_XVISOR) += cmd_fb_logo_xvisor.o
commands-objs-$(CONFIG_CMD_FB_LOGO_SYSTEMX) += cmd_fb_logo_sx.o
commands-objs-$(CONFIG_CMD_BACKLIGHT)+= cmd_backlight.o

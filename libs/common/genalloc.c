...
VMM_EXPORT_SYMBOL(gen_pool_create);
...
VMM_EXPORT_SYMBOL(gen_pool_add_virt);
...
VMM_EXPORT_SYMBOL(gen_pool_virt_to_phys);
...
VMM_EXPORT_SYMBOL(gen_pool_destroy);
...
VMM_EXPORT_SYMBOL(gen_pool_alloc);
...
VMM_EXPORT_SYMBOL(gen_pool_dma_alloc);
...
VMM_EXPORT_SYMBOL(gen_pool_free);
...
VMM_EXPORT_SYMBOL(gen_pool_for_each_chunk);
...
VMM_EXPORT_SYMBOL_GPL(gen_pool_avail);
...
VMM_EXPORT_SYMBOL_GPL(gen_pool_size);
...
VMM_EXPORT_SYMBOL(gen_pool_set_algo);
...
VMM_EXPORT_SYMBOL(gen_pool_first_fit);
...
VMM_EXPORT_SYMBOL(gen_pool_best_fit);
#endif /* 0 */
...
VMM_EXPORT_SYMBOL_GPL(dev_get_gen_pool);
...
VMM_EXPORT_SYMBOL_GPL(of_get_named_gen_pool);
